...
dbworld = my_mongo['world']
colCity = dbworld['city']
colCountry = dbworld['country']
colCL = dbworld['country language']

mongocity = colCity.insert_many(DictCity)
mongocountry = colCountry.insert_many(Dict_Country)
mongocl = colCL.insert_many(DictCL)
